...
var UnexpectedMitmRecorder = require('unexpected-mitm/lib/UnexpectedMitmRecorder');
...
module.exports.record = function record(promiseFactory) {
  return new UnexpectedMitmRecorder()
    .record(promiseFactory)
    .then(({ timeline }) => {
