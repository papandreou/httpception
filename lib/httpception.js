...
module.exports = function httpception(mockDefinition, promiseFactory) {
    ...
    if (promiseFactory) {
        ...
        return mocker.mock(promiseFactory).then(function () {
            return expect(promiseFactory, 'to perform HTTP traffic', mocker.requestDescriptions);
        }).then(function () {
            mocker = undefined;
        }).catch(function (e) {
            mocker = undefined;
        ...
        promise = Promise.all([
            ...
            return expect(function afterEach() {}, 'to perform HTTP traffic', mocker.requestDescriptions);
        }).then(function () {
            mocker = undefined;
        }).catch(function (e) {
            mocker = undefined;
